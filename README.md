...
`/home/jakob/Desktop/agartha/backend/graph-data`

This command initiates the Docker Container:  
`$ docker run -d   --name agartha   -p 8182:8182   -v /home/jakob/Desktop/agartha/backend/graph-data:/var/lib/janusgraph/data   janusgraph/janusgraph:latest`
